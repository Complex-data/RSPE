...
from parser_RSPE import *
from tylib.exp.exp_ops import *
from tylib.exp.experiment_rspe import Experiment
from tf_models.model_rspe import Model
...
class CFExperiment(Experiment):
    ...
    def model_wrapper(self):
        ...
        if(self.args.rnn_type == 'DeepCoNN'):
            ...
            self.args.base_encoder = 'Flat'
        elif(self.args.rnn_type == 'RSPE'):
            self.args.rnn_type = 'RAW_MSE_RSPE_FN_FM'
            self.args.base_encoder = 'NBOW'
        elif(self.args.rnn_type == 'RSPE_mlp'):
            self.args.rnn_type = 'RAW_MSE_RSPE_FN_MLP'
            self.args.base_encoder = 'NBOW'
